...
//             : 'mx-1 rounded-md px-3 py-2 text-purple-600 hover:bg-purple-100'
//         }`}
//       >
//         {i}
//       </button>
...
//         name="page"
//         onClick={() => goToPage(1)}
//         className="mx-1 rounded-md px-3 py-2 text-purple-600 hover:bg-purple-100"
//       >
//         &lt;&lt;
//       </button>
//       <button
      ...
      {hasNextPage ? (
        ...
        <>
          <button
            ...
            onClick={next}
            disabled={true}
            className="mx-1 rounded-md px-3 py-2 text-purple-300 hover:bg-purple-100"
          >
            &gt;
          </button>
          <button
